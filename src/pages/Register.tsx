    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <label className="flex items-start gap-2">
          <input type="checkbox" {...register('terms')} className="mt-1 h-4 w-4 rounded border-border text-brand-500 focus:ring-brand-500" />
          <span className="text-xs text-muted-foreground">I agree to the <a href="#" className="text-brand-500 hover:underline">Terms of Service</a> and <a href="#" className="text-brand-500 hover:underline">Privacy Policy</a></span>
        </label>
